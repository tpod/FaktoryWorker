...
public class FaktoryClientTests
{
    ...
    {
        await using var faktoryClient = new FaktoryClient("127.0.0.1", 7419);
    ...
    [Fact (Skip = "Can't get it to work in github actions")]
    public async Task HappyFlow_Using_TestContainers()
    {
